...
execute_process(
  COMMAND "E:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "2.6.1"
  WORKING_DIRECTORY "E:/Documents/.SFML/GravityPlanet/cmake-build-debug/_deps/sfml-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/Documents/.SFML/GravityPlanet/cmake-build-debug/_deps/sfml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/Documents/.SFML/GravityPlanet/cmake-build-debug/_deps/sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "E:/Program Files/Git/cmd/git.exe" --git-dir=.git submodule update --recursive --init 
    WORKING_DIRECTORY "E:/Documents/.SFML/GravityPlanet/cmake-build-debug/_deps/sfml-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
